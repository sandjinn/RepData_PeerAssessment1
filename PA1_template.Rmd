...
The mean value of the total number of steps taken per day is `r format(smean, scientific = FALSE)`.

The median of the total number of steps taken per day is `r format(smedian, scientific = FALSE)`.
...
estimate (`r format(smean, scientific = FALSE)`) and the processed data (`r format(smeanNA, scientific = FALSE)`).

But the median has increased from the estimate (`r format(smedian, scientific = FALSE)`) to the processed data
(`r format(smedianNA, scientific = FALSE)`).
...
```{r plotWeekEndOrDay, fig.height=8}
